...
<head>
    ...
    <link rel="stylesheet" href="/assets/89704060/css/adminlte.css">
...
<div class="app-wrapper">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown"><a class="nav-link" data-bs-toggle="dropdown" href="#"> <i class="bi bi-chat-text"></i> <span class="navbar-badge badge text-bg-danger">3</span> </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"><a href="#" class="dropdown-item">
                            <!--begin::Message-->
                            <div class="d-flex">
                                <div class="flex-shrink-0"><img src="/assets/89704060/assets/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 rounded-circle me-3"></div>
                        ...
                        <a href="#" class="dropdown-item">
                            <!--begin::Message-->
                            <div class="d-flex">
                                <div class="flex-shrink-0"><img src="/assets/89704060/assets/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 rounded-circle me-3"></div>
                                <div class="flex-grow-1">
                                    <h3 class="dropdown-item-title">
                                        John Pierce
                        ...
                        <a href="#" class="dropdown-item">
                            <!--begin::Message-->
                            <div class="d-flex">
                                <div class="flex-shrink-0"><img src="/assets/89704060/assets/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 rounded-circle me-3"></div>
                                <div class="flex-grow-1">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
                ...
                <li class="nav-item dropdown user-menu"><a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"> <img src="/assets/89704060/assets/img/user2-160x160.jpg" class="user-image rounded-circle shadow" alt="User Image"> <span class="d-none d-md-inline">Alexander Pierce</span> </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                        <!--begin::User Image-->
                        <li class="user-header text-bg-primary"><img src="/assets/89704060/assets/img/user2-160x160.jpg" class="rounded-circle shadow" alt="User Image">
                            <p>
    ...
    <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
            <!--begin::Brand Link--> <a href="../index.html" class="brand-link">
                <!--begin::Brand Image-->
                <img src="/assets/89704060/assets/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image opacity-75 shadow"> <!--end::Brand Image-->
                <!--begin::Brand Text-->
    ...
    <footer class="app-footer">
        ...
        <!--end::To the end-->
        <!--begin::Copyright--> <strong> Copyright &copy; <?= date('Y') ?>>&nbsp;
            <a href="https://net23.ru" class="text-decoration-none">Net23.ru</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
    </footer>
...
<!--begin::Required Plugin(AdminLTE)-->
<script src="/assets/89704060/assets/js/adminlte.js"></script>
<!--end::Required Plugin(AdminLTE)-->
