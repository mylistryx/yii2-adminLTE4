...
class ActiveForm extends \yii\widgets\ActiveForm
{
     ...
     */
    const string LAYOUT_HORIZONTAL = 'horizontal';
    /**
     * Inline form layout
     */
    const string LAYOUT_INLINE = 'inline';
    /**
     * Floating labels form layout
     */
    const string LAYOUT_FLOATING = 'floating';
     ...
     * @see ActiveField for details on AdminLTE4 field configuration
     */
