 ...
 *
 * You can use this widget in an [[\yii\adminlte4\ActiveForm|ActiveForm]] using the [[\yii\adminlte4\ActiveField::widget()|widget()]]
 * method, for example like this:
 *
 * ```php
 * <?= $form->field($model, 'item_id')->widget(\yii\adminlte4\ToggleButtonGroup::class, [
 *     'type' => \yii\adminlte4\ToggleButtonGroup::TYPE_CHECKBOX
 *     'items' => [
 *         'fooValue' => 'BarLabel',
 *         'barValue' => 'BazLabel'
 *     ]
